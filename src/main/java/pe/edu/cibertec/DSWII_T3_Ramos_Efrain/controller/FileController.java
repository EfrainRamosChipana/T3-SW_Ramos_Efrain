...
public class FileController {
    ...
    private static final String DIRECTORY = System.getProperty("user.dir") + "/Docvz";

    @PostMapping("/filesdoc")
    public ResponseEntity<String> uploadFile(MultipartFile file) {

        if (!file.getOriginalFilename().endsWith(".doc")) {
            return new ResponseEntity<>("Solo se permiten los archivos .doc", HttpStatus.BAD_REQUEST);
        }
